...
abstract class SSLSocket : Socket
{
     ...
     */
    protected this(string host, int port)
    { 
        Address address = new InternetAddress(host, cast(ushort)port);
        super(address.addressFamily, SocketType.STREAM, ProtocolType.TCP); 
        connect(address);
    }
     ...
     * @see SecurityManager#checkConnect
     */
    // protected this(InternetAddress address, int port)
    //     { super(address, port); }
     ...
     * @see SecurityManager#checkConnect
     */
    // protected this(string host, int port, InternetAddress clientAddress, int clientPort)
     ...
     */
    // protected this(InternetAddress address, int port,
    //     InternetAddress clientAddress, int clientPort)
     ...
     */
    abstract void setUseClientMode(bool mode);
     ...
     */
    abstract bool getUseClientMode();
     ...
     * @see #setUseClientMode(bool)
     */
    abstract void setNeedClientAuth(bool need);
     ...
     * @see #setUseClientMode(bool)
     */
    abstract bool getNeedClientAuth();
     ...
     * @see #setUseClientMode(bool)
     */
    abstract void setWantClientAuth(bool want);
     ...
     * @see #setUseClientMode(bool)
     */
    abstract bool getWantClientAuth();
     ...
     */
    abstract void setEnableSessionCreation(bool flag);
     ...
     */
    abstract bool getEnableSessionCreation();
