 ...
 * under the License.
 */
module hunt.net.buffer.ReferenceCountUpdater;
 ...
 */
abstract class ReferenceCountUpdater(T) if(is(T : ReferenceCounted)) {
    // /*
    ...
    // // static long getUnsafeOffset(Class<? extends ReferenceCounted> clz, String fieldName) {
    // //     try {
    ...
    // final int refCnt(T instance) {
    //     return realRefCnt(updater().get(instance));
    // }

    // final bool isLiveNonVolatile(T instance) {
    //     final long offset = unsafeOffset();
    ...
    //  */
    // final void setRefCnt(T instance, int refCnt) {
    ...
    //  */
    // final void resetRefCnt(T instance) {
    //     updater().set(instance, initialValue());
    // }

    // final T retain(T instance) {
    //     return retain0(instance, 1, 2);
    // }

    // final T retain(T instance, int increment) {
    ...
    // final bool release(T instance) {
    //     int rawCnt = nonVolatileRawCnt(instance);
    //     return rawCnt == 2 ? tryFinalRelease0(instance, 2) || retryRelease0(instance, 1)
    //             : nonFinalRelease0(instance, 1, rawCnt, toLiveRealRefCnt(rawCnt, 1));
    // }

    // final bool release(T instance, int decrement) {
    //     int rawCnt = nonVolatileRawCnt(instance);
