 ...
 * under the License.
 */
module hunt.net.buffer.FixedCompositeByteBuf;
 ...
 */
// final class FixedCompositeByteBuf : AbstractReferenceCountedByteBuf {
//     private __gshared ByteBuf[] EMPTY() {
...
//     }
    ...
    // this(ByteBufAllocator allocator, ByteBuf[] buffers...) {
...
private static final class Component : WrappedByteBuf {
    private int index;
    private int offset;
    private int endOffset;

    this(int index, int offset, ByteBuf buf) {
        super(buf);
        this.index = index;
        this.offset = offset;
